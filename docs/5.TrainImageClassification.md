...
[BEST] Đã lưu model với accuracy: 0.6930
...
[BEST] Đã lưu model với accuracy: 0.7430
...
Mô hình đạt hiệu suất rất tốt với **accuracy tổng thể là 87.10%**, điều này cho thấy mô hình đã học được cách phân biệt giữa các số áo cầu thủ một cách hiệu quả.